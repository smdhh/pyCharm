...
class MaFenetre(QtWidgets.QDialog):
    ...
    def create_widgets(self):
        ...
        self.LEdit_Somme = QtWidgets.QRadioButton()
        self.lbl_Produit = QtWidgets.QLabel("Produit")
        self.LEdit_Produit = QtWidgets.QRadioButton()
    ...
    def addWigets_to_layouts(self):
        ...
        self.layoutH1.addWidget(self.lbl_Somme)
        self.layoutH1.addWidget(self.LEdit_Somme)
        self.layoutH1.addWidget(self.lbl_Produit)
